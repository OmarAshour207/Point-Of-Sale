                ...
                <div class="box-header with-border">
                    ...
                    <form action="{{ route('dashboard.products.index') }}" method="get">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                               <select name="category_id" class="form-control" value="{{ request()->category_id != '' ? request()->category_id : ''}}">
                        ...
                        <table class="table table-bordered">
                            ...
                            @foreach($products as $index => $product)
                                <tr>
                                    ...
                                    <td> <img src="{{ $product->image_path }}" alt="Product Image" style="width: 100px;" class="img-thumbnail"> </td>
